...
| `JWT_PRIVATE_KEY`         | ✅       | Generated by `npx @convex-dev/auth generate-keys` (set on Convex, not Vercel) |
| `JWKS`                    | ✅       | Generated by `npx @convex-dev/auth generate-keys` (set on Convex, not Vercel) |
